...
class _ContactsPageState extends State<ContactsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_singleton.userData?.child("contacts").child(_singleton.currentCategory).value != null) {
        contacts = _singleton.userData?.child("contacts").child(_singleton.currentCategory).value as List<dynamic>;
    }
    return Scaffold(
          ...
          child: Column(
              children: [
                              ...
                              children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListView(
                                        ...
                                        children: [
                                            ElevatedButton(onPressed: () {}, style: ElevatedButton.styleFrom(backgroundColor: Colors.white), child: Text("Can you come pick me up.", style: TextStyle(color: Colors.black))),
                                            ElevatedButton(onPressed: () {}, style: ElevatedButton.styleFrom(backgroundColor: Colors.white), child: Text("I'm currently drunk, can you get help?", style: TextStyle(color: Colors.black))),
                      ...
                      Row(
                        ...
                        children: [
                            ...
                            ElevatedButton(onPressed: () {
                                ...
                                print(update);
                                final ref =  FirebaseDatabase.instance.ref("user/${Auth().user?.uid}/contacts/${_singleton.currentCategory}");
                                print("users/${Auth().user?.uid}/contacts/${_singleton.currentCategory}");
                  ...
                  ListView(
                    ...
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    children: contacts.map((contact) => ContactCard(
