          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                height: 50,
                child: ElevatedButton(
                    onPressed: (categoryNameController.text != "")
                        ? () {
                            final ref = FirebaseDatabase.instance
                                .ref("users/${Auth().user?.uid}/categories");
                            print("users/${Auth().user?.uid}/categories");
                            List<dynamic> user_categories = List<dynamic>.from(
                                _singleton.userData?.child("categories").value
                                    as List<dynamic>);
                            user_categories.add({
                              "name": categoryNameController.text,
                              "color": colorToName[colorSelection],
                              "icon": iconsToString[iconSelection]
                            });
